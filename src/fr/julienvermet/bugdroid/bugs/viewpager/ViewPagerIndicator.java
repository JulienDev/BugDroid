...
public class ViewPagerIndicator extends RelativeLayout implements OnPageChangeListener {
	...
	public void setArrows(Drawable prev, Drawable next){
		...
		int[] unfocusedColor = {146,155,177};
		setUnfocusedTextColor(unfocusedColor);

		int[] focusedColor = {255,0,0};
		setFocusedTextColor(focusedColor);
	...
	private void addContent(){
		mFocusedTextColor = new int[]{255, 0, 0};
		...
		mPrevious.setTextSize(17);
		mCurrent.setText("current");
		mCurrent.setTextSize(17);
		mNext.setText("next");
		mNext.setTextSize(17);
		...
		mCurrent.setTextColor(Color.argb(255, mFocusedTextColor[0], mFocusedTextColor[1], mFocusedTextColor[2]));
		updateColor(0);
	}
